...
"""
Create two datasets from the amazon_reviews file: a balanced training set and an unbalanced test set.
They are already preprocessed and split into training and test sets.
The datasets are in the the path dataset/dataset_1.
"""
