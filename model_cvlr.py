...
if __name__ == '__main__':
    ...
    metrics_with_three_classes(model_cvlr.model, X_test_balanced, y_test_balanced, 'Naive Bayes Balanced Data')
    ...
    metrics_with_three_classes(model_cvlr.model, X_test_real, y_test_real, 'Naive Bayes Real Test')"""